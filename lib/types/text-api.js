  ...
  _onOp: function(op) {
    ...
    for (var i = 0; i < op.length; i++) {
      ...
      switch (typeof component) {
        ...
        case 'string':
          if (replace) {
            if (this.onReplace) this.onReplace(replace.pos, replace.len, component);
            replace = null;
          } else {
          ...
          break;
        case 'object':
          if (component.m && component.m.r) {
            replace = {pos: pos, len: component.d};
          } else {
